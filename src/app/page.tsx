  ...
  return (
    <div className="lg:px-48 px-4">
      ...
      <div className="space-y-4 ">
        <div className="text-5xl flex items-center space-x-4 font-bold">About<span className="text-primary">.</span> <Separator /></div>
        <div className="grid md:grid-cols-3 grid-cols-1 gap-4">
          ...
          <div className="space-y-6">
            <div className="flex space-x-3 text-xl items-center"> <IconTerminalFill /><div>Use at work</div></div>
